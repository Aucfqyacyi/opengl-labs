    ...
    : m_hRC(NULL), step(5), error(false), kod_zapol(1), xRot(0.0f), yRot(0.0f), zRot(0.0f)
{
    ...
    {
        { { -8.0, -8.0, 1.0 }, { -4.0, -8.0, 1.0 }, { 0.0, -8.0, 1.0 }, { 4.0, -8.0, 1.0 }, { 8.0, -8.0, 1.0 } },
        { { -8.0, -4.0, 1.0 }, { -4.0, -4.0, 7.0 }, { 0.0, -4.0, 7.0 }, { 4.0, -4.0, 7.0 }, { 8.0, -4.0, 1.0 } },
        { { -8.0,  0.0, 1.0 }, { -4.0,  0.0, 8.0 }, { 0.0,  0.0, 8.0 }, { 4.0,  0.0, 8.0 }, { 8.0,  0.0, 1.0 } },
        { { -8.0,  4.0, 1.0 }, { -4.0,  4.0, 3.0 }, { 0.0,  4.0, 3.0 }, { 4.0,  4.0, 3.0 }, { 8.0,  4.0, 1.0 } },
        { { -8.0,  8.0, 1.0 }, { -4.0,  8.0, 1.0 }, { 0.0,  8.0, 1.0 }, { 4.0,  8.0, 1.0 }, { 8.0,  8.0, 1.0 } }
    };
    for (int i = 0; i < 5; ++i)
        for (int j = 0; j < 5; ++j)
